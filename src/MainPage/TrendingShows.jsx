...
function TrendingShows() {
    ...
    useEffect(() => {
      axios.get(`https://api.themoviedb.org/3/tv/popular?api_key=c8b147e9fe4390650885295607b0a593&page=1`)
  ...
  return (
    ...
    <span className='ml-8 mr-4 flex justify-between'>
      <div className='text-[#ffffff] text-[20px] font-[600]'>Trending Shows</div>
