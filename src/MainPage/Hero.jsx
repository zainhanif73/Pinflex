          ...
          <span className=''>
            ...
            <Fade Top duration={5000}>
              <span className='flex ml-16'>
                ...
                <span onClick={() => { setopen(true) }} className='text-[#ffffff] font-[600] text-[15.3px] ml-4 mt-8 rounded-[3px] border-2 border-[#ffffff] hover:bg-[#ffffff] cursor-pointer hover:text-[#ff0000] px-6 p-2 h-[40px]'>
                  Watch trailer
                </span>
              </span>
            </Fade>
